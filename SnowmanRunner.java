...
// The tester framework for the old "Snowman" programming project for old version of CPS109.
...
public class SnowmanRunner {
    ...
    public static void main(String[] args) {
        ...
        final int SEED = 64323121;
        final String PASSPHRASE = // as illustrated in https://xkcd.com/936/
        "A silly little string to be used as seed for scrambling the internal wordlist..?";
        
        // How many rounds of Snowman is played.
        final int ROUNDS = 50;
        // Whether to output the individual word action, instead of just final score.
        final boolean VERBOSE = true;
        // Word maximum and minimum length.
        final int MINLENGTH = 5;
        final int MAXLENGTH = 20;
        String WORDFILE = "words_alpha.txt";
        String ALLOWED = "abcdegfhijklmnopqrstuvwxyz";
        ...
        try {
            ...
            if(VERBOSE) {
                System.out.print("Read in " + totalCount + " words.\n");
            }
        } catch(Exception e) {
