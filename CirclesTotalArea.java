// Problem taken from https://rosettacode.org/wiki/Total_circles_area
...
public class CirclesTotalArea {
    ...
    private static double totalArea(double[] rect, double[][] circs, int d) {    
        ...
        double w = rect[2] * 0.5; // New width
        double h = rect[3] * 0.5; // New height
        double[][] pieces = {
            { rect[0], rect[1], w, h }, // NW
            { rect[0] + w, rect[1], rect[2] - w, h }, // NE
            { rect[0], rect[1] - h, w, rect[3] - h }, // SW
            { rect[0] + w, rect[1] - h, rect[2] - w, rect[3] - h } // SE
        };
        double total = 0;
    ...
    public static void main(String[] args) {
        double[][] circs = { // Example from Rosetta Code
